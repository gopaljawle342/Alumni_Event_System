...
<body>
	...
	<div class="content">
		<div id="take-attendance" class="form-section">
			...
			<div class="mb-3">
				<label for="eventSelect" class="form-label">Select Event</label> <select
					class="form-select" id="eventSelect">
					<c:if test="${elist.size()==0 }">
						<option disabled> disabled No Completed Event...</option>
					</c:if>
			...
			<table class="table table-dark" id="studentTable">
				...
				<tbody id="studentBodyTable">
					<!-- <tr>
						...
						<td><a href="#" class="attendance-btn absent"
							onclick="toggleAttendance(this)">Absent</a></td>
					</tr>
					<tr>
						<td>2</td>
						<td>Jane Smith</td>
						...
						<td><a href="#" class="attendance-btn absent"
							onclick="markAttendance(this.id)">Absent</a></td>
					</tr> -->
